...
<body>
            ...
            <div class="container-md">
                <ul class="navbar-nav align-items-center">
                    ...
                    <li class="nav-item mx-5">
                        <a class="nav-link" href="?view=shop">SHOP</a>
                    </li>
                    <li class="nav-item mx-5">
    ...
    <!-- <a href="?view=user" class="account text-dark text-decoration-none">
        ...
        <div class="row">
            <div class="col col-4">
                <div class="heading-department d-flex align-items-center gap-4 cursor-pointer text-light px-3 position-relative w-100">
                    ...
                    <ul class="menu list-unstyled position-absolute w-80">
                        <?php
                        if ($show_cartegory) {
                            while ($result = $show_cartegory->fetch_assoc()) {
                        ?>
                                <li class="py-2 px-5 "><a href="?view=shop&cartegory_id=<?php echo $result['cartegory_id'] ?>" class="text-decoration-none text-dark fw-normal fs-6"><?php echo $result['cartegory_name'] ?></a></li>
                        <?php
